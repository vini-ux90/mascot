    ...
    <div className='md:grid grid-cols-3 border p-3 py-5 rounded'>
        ...
        <div className='col-span-1  p-5 '>
                <div className='rounded bg-white p-3 shadow-lg md:mt-14'>
                    ...
                    <p className='text-sm hover:text-orange-500 hover:underline'>-Request Managment</p>
                    <MdToggleOn className='text-green-500' size={35}/>

                    </div>  

                    <div className='flex justify-between items-center md:px-3'>
                    <p className='text-sm hover:text-orange-500 hover:underline'>-Dispatch Management</p>
                    <MdToggleOn className='text-green-500' size={35}/>

                    </div>

                    <div className='flex justify-between items-center md:px-3'>
                    <p className='text-sm hover:text-orange-500 hover:underline'>-Sales Order Management</p>
                    <MdToggleOn className='text-green-500' size={35}/>

                    </div>

                    <div className='flex justify-between items-center md:px-3'>
                    <p className='text-sm hover:text-orange-500 hover:underline'>-Customer Management</p>
                    <MdToggleOn className='text-green-500' size={35}/>

                    </div>

                    <div className='flex justify-between items-center md:px-3'>
                    <p className='text-sm hover:text-orange-500 hover:underline'>-Vendor Management</p>
                    <MdToggleOn className='text-green-500' size={35}/>

                    </div>

                    <div className='flex justify-between items-center md:px-3'>
                    <p className='text-sm hover:text-orange-500 hover:underline'>-POD Management</p>
                    <MdToggleOn className='text-green-500' size={35}/>

                    </div>

                    <div className='flex justify-between items-center md:px-3'>
                    <p className='text-sm hover:text-orange-500 hover:underline'>-Customer Payment Management</p>
                    <MdToggleOn className='text-green-500' size={35}/>

                    </div> 

                    <div className='flex justify-between items-center md:px-3'>
                    <p className='text-sm hover:text-orange-500 hover:underline'>-Vendor Payment Management</p>
                    <MdToggleOn className='text-green-500' size={35}/>
