...
const Footer = () => {
  ...
  <div class="container">
    <div class="row gx-5 pb-10 pt-[52px]">
      ...
      <div class="col-12 mt-12 md:col-6 lg:col-3">
        <h6>Socials</h6>
        <p>info@mascotitsolutions.com</p>
      ...
      <div class="col-12 mt-12 md:col-6 lg:col-3">
        ...
        <p>Metro Pillar Number 564, 14/3, Mathura Rd, Sector 31, Faridabad, Haryana 121003</p>
        <a href='tel:919810073129'>+91 9810073129</a>
      </div>
    </div>
  </div>
  <div class="container max-w-[1440px]">
    ...
    >
      <p>Designed And Developed by <a href="https://mascotitsolutions.com" target="_blank">mascotitsolutions.com</a></p>
